    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.CharField(default='张三', max_length=50, verbose_name='昵称')),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='生日')),
                ('gender', models.CharField(choices=[('male', '男'), ('demale', '女')], default='female', max_length=10, verbose_name='性别')),
